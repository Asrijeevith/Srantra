...
import { 
  ...
  Layers, Code, Cloud, Server, Cpu, Lock, Shield, Zap as Lightning, 
        ...
        <div className="relative">
          ...
          >
            <motion.div
              ...
              className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-gray-800"
            >
              <motion.h2 className="text-3xl md:text-4xl font-bold mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-400" variants={fadeInUp}>
                Meet Our Team
              </motion.h2>
